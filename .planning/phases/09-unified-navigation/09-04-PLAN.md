...
**Note:** NAV-04 (COP section navigation) is explicitly deferred per ROADMAP.md decision. This phase completes NAV-01, NAV-02, NAV-03, and NAV-05 only.
...
**NAV-04 Deferral Note:** Per ROADMAP.md, COP section navigation (existing substrate/category hierarchy) remains unchanged. This phase focuses only on topic-based navigation.
  </action>
  <verify>
...
Scope: NAV-01, NAV-02, NAV-03, NAV-05 (NAV-04 explicitly deferred)
  </what-built>
  <how-to-verify>
...
15. Verify existing substrate/category navigation (Planner mode) still works unchanged
  </how-to-verify>
...
7. Existing COP section navigation (NAV-04) remains unchanged (deferred)
</verification>

<success_criteria>
- NAV-01: User can discover and browse topics from unified topics page
...
- NAV-05: Coming Soon placeholder shows for topics without content
...
- NAV-04 explicitly out of scope (deferred per ROADMAP.md)
</success_criteria>
