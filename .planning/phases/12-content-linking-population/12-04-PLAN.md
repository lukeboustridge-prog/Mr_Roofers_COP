...
7. Verify combined view on detail page:
   - Pick one linked MRM detail from the links table
   - Navigate to its detail page (e.g., /planner/[substrate]/[category]/[id])
   - Verify the page shows MRM specifications (from the MRM detail)
   - Verify the 3D tab shows the RANZ model with "Provided by RANZ Guide" attribution
   - This confirms LINK-03: linked content composes into a unified detail view
