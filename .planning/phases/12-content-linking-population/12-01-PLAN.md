...
must_haves:
  truths:
    - "Script generates link suggestions with confidence scores"
    - "API supports link CRUD operations"
    - "Suggestions include exact, partial, and related matches"
    - "MRM is always primary, RANZ is always supplementary"
  artifacts:
